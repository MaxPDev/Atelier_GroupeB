...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 04, 2021 at 10:45 AM
...
INSERT INTO `order` (`id`, `name`, `mail`, `phone`, `state`, `place`) VALUES
('1065685370', 'quidem', 'torey13@example.org', '1-156-697-7885', 'Orderd', 'Nancy'),
('1080901668', 'odit', 'amelia37@example.org', '186-750-3400x67859', 'Orderd', 'Nancy'),
('1129784005', 'dolores', 'reymundo17@example.net', '563-159-5969x35314', 'Orderd', 'Nancy'),
('1162599804', 'illum', 'annie81@example.org', '(012)414-0368', 'Orderd', 'Nancy'),
('1163993588', 'natus', 'blair38@example.net', '475-548-3956x4771', 'Orderd', 'Nancy'),
('1181892209', 'vel', 'alueilwitz@example.com', '1-924-322-5056', 'Orderd', 'Nancy'),
('1185351490', 'dolores', 'eleanora.considine@example.net', '04360430467', 'Orderd', 'Nancy'),
('1206435501', 'nobis', 'howe.edgardo@example.net', '(113)726-1454', 'Orderd', 'Nancy'),
('1219327142', 'voluptates', 'ifahey@example.org', '(197)524-9901x725', 'Orderd', 'Nancy'),
('122139421', 'quae', 'zula28@example.net', '156.918.1428x4373', 'Orderd', 'Nancy'),
('1223667841', 'recusandae', 'zula28@example.net', '698-628-1395x571', 'Orderd', 'Nancy'),
('1237429351', 'ipsum', 'zula28@example.net', '+85(3)5745018160', 'Orderd', 'Nancy'),
('1238777359', 'quibusdam', 'luis.dietrich@example.com', '05935577144', 'Orderd', 'Nancy'),
('1240730423', 'quis', 'felicia07@example.net', '+04(8)7574571605', 'Orderd', 'Nancy'),
('1280071483', 'aliquam', 'prosacco.corene@example.net', '(653)198-9312', 'Orderd', 'Nancy'),
('1305560941', 'a', 'mo\'keefe@example.net', '719.152.2764', 'Orderd', 'Nancy'),
('1316936126', 'nihil', 'blanda.olin@example.org', '915.533.9456x68843', 'Orderd', 'Nancy'),
('1327248741', 'est', 'nraynor@example.org', '+88(5)4661661387', 'Orderd', 'Nancy'),
('1359149874', 'fuga', 'amy40@example.org', '1-070-600-8320', 'Orderd', 'Nancy'),
('1359889299', 'tempore', 'witting.henry@example.net', '873.865.2402', 'Orderd', 'Nancy'),
('1361247100', 'aut', 'gjenkins@example.org', '1-410-482-1663', 'Orderd', 'Nancy'),
('1402963805', 'ab', 'wilton18@example.net', '139-843-0228', 'Orderd', 'Nancy'),
('1404145870', 'est', 'hane.mackenzie@example.com', '739.538.3277', 'Orderd', 'Nancy'),
('1409219578', 'aliquam', 'jerel78@example.com', '(175)042-0097', 'Orderd', 'Nancy'),
('1412131742', 'voluptatem', 'schaefer.glenda@example.net', '1-259-251-2279', 'Orderd', 'Nancy'),
('1431717743', 'reiciendis', 'hershel.schamberger@example.com', '+39(0)6030622625', 'Orderd', 'Nancy'),
('1433203083', 'vero', 'adams.arnold@example.org', '744.913.9901', 'Orderd', 'Nancy'),
('1450124659', 'expedita', 'vidal.cronin@example.net', '+81(9)4667311627', 'Orderd', 'Nancy'),
('1473858198', 'eius', 'elissa.wunsch@example.org', '239.282.8111x466', 'Orderd', 'Nancy'),
('1480247930', 'similique', 'haylee88@example.net', '511.767.4812x068', 'Orderd', 'Nancy'),
('1504886671', 'sapiente', 'jameson.koch@example.org', '(782)616-5081', 'Orderd', 'Nancy'),
('1511794963', 'voluptatibus', 'zfritsch@example.net', '(020)490-2433x62818', 'Orderd', 'Nancy'),
('1514759036', 'velit', 'heather.welch@example.net', '(888)446-0539x7770', 'Orderd', 'Nancy'),
('155697529', 'molestiae', 'sven35@example.com', '366-642-1198x186', 'Orderd', 'Nancy'),
('1569947801', 'est', 'leslie.deckow@example.net', '519-087-1426', 'Orderd', 'Nancy'),
('1579549381', 'sed', 'tito09@example.com', '945-722-6643x91179', 'Orderd', 'Nancy'),
('1583689980', 'ipsa', 'qhansen@example.org', '769-589-6841', 'Orderd', 'Nancy'),
('158606298', 'quo', 'elaina94@example.org', '038.139.4342x0995', 'Orderd', 'Nancy'),
('1611622425', 'magni', 'adams.jalen@example.net', '386-502-7188', 'Orderd', 'Nancy'),
('1613824065', 'sequi', 'o\'conner.jennifer@example.org', '1-832-285-5587x1430', 'Orderd', 'Nancy'),
('162169803', 'et', 'gwisozk@example.net', '1-180-687-3158', 'Orderd', 'Nancy'),
('1633747987', 'ut', 'khermiston@example.org', '(948)203-8433x0814', 'Orderd', 'Nancy'),
('170440443', 'sunt', 'mavis.o\'kon@example.org', '190-009-2869x51627', 'Orderd', 'Nancy'),
('170521408', 'natus', 'roberta.rowe@example.org', '426.866.9832', 'Orderd', 'Nancy'),
('175144220', 'consequatur', 'rohan.alva@example.com', '(151)863-8957x848', 'Orderd', 'Nancy'),
('208555260', 'voluptas', 'albina56@example.org', '1-110-254-0887', 'Orderd', 'Nancy'),
('210305936', 'facilis', 'cbotsford@example.org', '1-545-549-8353x192', 'Orderd', 'Nancy'),
('270316660', 'qui', 'grayson81@example.net', '04876277290', 'Orderd', 'Nancy'),
('29127819', 'sint', 'vleuschke@example.org', '329.163.4392x272', 'Orderd', 'Nancy'),
('298089406', 'veritatis', 'qreichel@example.com', '1-735-116-8942', 'Orderd', 'Nancy'),
('306620562', 'sequi', 'jamir59@example.org', '(296)708-8704', 'Orderd', 'Nancy'),
('339711842', 'qui', 'pbauch@example.net', '1-719-587-6910x55189', 'Orderd', 'Nancy'),
('34873020', 'accusantium', 'luettgen.scottie@example.org', '+51(9)4747721190', 'Orderd', 'Nancy'),
('383694357', 'qui', 'shammes@example.org', '299.664.3160', 'Orderd', 'Nancy'),
('400666845', 'accusamus', 'ggislason@example.com', '1-981-780-3647x35275', 'Orderd', 'Nancy'),
('436497471', 'animi', 'katrine.koch@example.net', '1-694-071-6093x184', 'Orderd', 'Nancy'),
('438873583', 'atque', 'ruecker.angus@example.org', '1-400-060-5643x9989', 'Orderd', 'Nancy'),
('447151927', 'quia', 'ystark@example.com', '428.852.1713', 'Orderd', 'Nancy'),
('482915728', 'alias', 'ecruickshank@example.net', '1-559-847-1894x97366', 'Orderd', 'Nancy'),
('482925689', 'sed', 'cronin.vincenza@example.net', '224-530-6970x021', 'Orderd', 'Nancy'),
('499644667', 'beatae', 'eloise.bailey@example.com', '1-113-116-5992x67119', 'Orderd', 'Nancy'),
('506352560', 'placeat', 'rmurray@example.org', '855.976.5572', 'Orderd', 'Nancy'),
('524992146', 'illo', 'mpacocha@example.org', '01237265341', 'Orderd', 'Nancy'),
('549067010', 'rem', 'bashirian.alba@example.net', '1-182-446-4037x217', 'Orderd', 'Nancy'),
('572033833', 'aut', 'marquardt.orval@example.org', '1-401-355-2781', 'Orderd', 'Nancy'),
('572886342', 'molestiae', 'annalise.schuster@example.net', '1-771-505-9740x352', 'Orderd', 'Nancy'),
('585267866', 'itaque', 'lueilwitz.antwon@example.com', '(560)794-1079', 'Orderd', 'Nancy'),
('642360378', 'doloribus', 'zfahey@example.org', '1-844-137-4863', 'Orderd', 'Nancy'),
('645565391', 'et', 'vcummerata@example.org', '229.230.4860x703', 'Orderd', 'Nancy'),
('654667563', 'sint', 'weissnat.soledad@example.com', '245.052.7694x505', 'Orderd', 'Nancy'),
('655269312', 'tenetur', 'dfahey@example.org', '+24(1)8887140971', 'Orderd', 'Nancy'),
('660517746', 'corporis', 'abshire.johnpaul@example.net', '620-362-2442', 'Orderd', 'Nancy'),
('665437040', 'nobis', 'alejandrin78@example.net', '02668010211', 'Orderd', 'Nancy'),
('672018066', 'commodi', 'sadye46@example.com', '1-741-843-2378x31683', 'Orderd', 'Nancy'),
('681677560', 'corrupti', 'rosemary96@example.org', '1-203-925-1368x983', 'Orderd', 'Nancy'),
('701125026', 'animi', 'bgutkowski@example.org', '1-458-626-7017x388', 'Orderd', 'Nancy'),
('708913432', 'ea', 'toy.jude@example.org', '1-981-984-0874', 'Orderd', 'Nancy'),
('726674547', 'aliquam', 'keyshawn.bode@example.net', '732-055-1243', 'Orderd', 'Nancy'),
('755217798', 'qui', 'carlie14@example.org', '895-491-4161x5257', 'Orderd', 'Nancy'),
('775418294', 'id', 'hmueller@example.com', '604.463.0412x122', 'Orderd', 'Nancy'),
('793809478', 'id', 'corene04@example.org', '1-163-930-4713', 'Orderd', 'Nancy'),
('80776083', 'quod', 'koch.eliza@example.com', '(434)086-9026x78495', 'Orderd', 'Nancy'),
('819151596', 'cupiditate', 'mwolff@example.org', '211-317-6452x02770', 'Orderd', 'Nancy'),
('821988499', 'sunt', 'mason94@example.org', '(695)327-0876x3356', 'Orderd', 'Nancy'),
('825652595', 'minima', 'mpacocha@example.org', '1-952-630-9962x833', 'Orderd', 'Nancy'),
('827955257', 'vitae', 'maribel08@example.com', '(871)928-2803x0231', 'Orderd', 'Nancy'),
('83483532', 'accusantium', 'wmosciski@example.org', '(291)288-0155', 'Orderd', 'Nancy'),
('839817934', 'et', 'angelina.herman@example.org', '880.724.1932x241', 'Orderd', 'Nancy'),
('867569378', 'pariatur', 'volkman.tamara@example.net', '088-980-0178', 'Orderd', 'Nancy'),
('870382684', 'blanditiis', 'jcorkery@example.org', '(893)035-1494x7832', 'Orderd', 'Nancy'),
('875890644', 'cupiditate', 'jenkins.dixie@example.com', '1-253-629-7381x0235', 'Orderd', 'Nancy'),
('876274616', 'harum', 'fgrant@example.net', '1-182-062-7350x543', 'Orderd', 'Nancy'),
('885685951', 'cumque', 'samir63@example.net', '337-409-9805x229', 'Orderd', 'Nancy'),
('888304657', 'mollitia', 'sreichert@example.com', '(705)411-2129x909', 'Orderd', 'Nancy'),
('893472356', 'ipsa', 'cgleason@example.com', '1-666-953-3449', 'Orderd', 'Nancy'),
('893864365', 'suscipit', 'bill.yundt@example.net', '(668)803-1835x89516', 'Orderd', 'Nancy'),
('952561726', 'similique', 'rafaela.ziemann@example.com', '(985)314-6193', 'Orderd', 'Nancy'),
('956543800', 'eum', 'tressie.kautzer@example.org', '920-424-3289x970', 'Orderd', 'Nancy'),
('963486230', 'quae', 'frederic.strosin@example.org', '1-184-295-9055x66540', 'Orderd', 'Nancy'),
('980982699', 'molestias', 'aebert@example.com', '1-430-329-6453x548', 'Orderd', 'Nancy');
